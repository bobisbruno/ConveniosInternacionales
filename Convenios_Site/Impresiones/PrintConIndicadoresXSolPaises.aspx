<%@ Page Title="Totales por paises ingresados" Language="C#" AutoEventWireup="true" CodeFile="PrintConIndicadoresXSolPaises.aspx.cs"
    Inherits="PrintConIndicadoresXSolPaises" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Impresión de totales por pais ingresados</title>
                    ...
                    <td valign="top" >
                        <center>
                            ...
                            <tr>
                                ...
                                <td style=" width:25%"><asp:Label ID="lblTotalPais" runat="server"></asp:Label></td>
