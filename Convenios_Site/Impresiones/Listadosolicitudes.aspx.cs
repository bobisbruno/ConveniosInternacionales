...
public partial class Listadosolicitudes : System.Web.UI.Page
{
    protected List<SolicitudesEFechasSolicitud> iList = null;
    ...
    protected void CargarDatos()
    {
        try
        {
            ...
            {
                iList = (List<SolicitudesEFechasSolicitud>)Session["_solicToExport"];

                lblfechas.Text = Request.QueryString["fd"].ToString() + " y " + Request.QueryString["fh"].ToString();

                gridListadoSolicitudes.DataSource = toDataTable(iList);
