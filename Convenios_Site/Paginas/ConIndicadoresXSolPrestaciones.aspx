<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="ConIndicadoresXSolPrestaciones.aspx.cs" Inherits="Paginas_ConIndicadoresXSolPrestaciones" Title="Indicador de solicitudes por prestaciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <h1>
        ...
        <div align="center" style="margin-top: 10px; padding-right:10px">
            <asp:Button   ID="btnConsultar" runat="server" CssClass="Botones" Text="Consultar" Width="110px" TabIndex="4"
                OnClick="btnConsultar_Click" ValidationGroup="paramConsulta" Height="20"/>&nbsp;
            ...
            <asp:Button   ID="btnImprimir" runat="server" CssClass="Botones" Text="Imprimir" Width="90px" Height="20" TabIndex="6"
                        OnClientClick="abrirArchivo();return false;"/>&nbsp;
            <asp:Button   ID="btnToExcell"  runat="server" CssClass="Botones" Text="Exportar a Excell"  Width="100px" Height="20" TabIndex="7"
                        onclick="btnToExcell_Click"/>
            </div></div>
        <div id="dvDatosConsulta" runat="server" align="center" class="FondoClaro" style="margin-top: 5px; padding-top: 10px; padding-bottom: 10px; margin-bottom:10px; width:98%">
        <div  style="text-align:center; width:98%">
            ...
            <div style=" width:70%; text-align:left">
                            ...
                            <tr>
                                <td style=" width:50%">Prestación</td>
        ...
        dvMes.style.display = eval(valor == 3) ? '' : 'none';
            ...
            <script language="javascript" type="text/javascript">
                function abrirArchivo() {
                    ...
                    window.open('../Impresiones/PrintConIndicadoresXSolPrestaciones.aspx?caption=' + txtcap + '&tGrafico=' + txttgr);
                    return false;
                }
        </script>
</asp:Content>
